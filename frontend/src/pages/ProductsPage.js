    ...
    <>
      ...
      <section className="hero" id="home">
        ...
        <div className="hero-content">
          ...
          <h1>
            Wear the <em>Energy</em>
            <br />
            of the Earth
          </h1>
          <p>
            Premium gemstone bracelets handcrafted in Khambhat, Gujarat. Each
            piece carries the healing power of authentic natural crystals.
          </p>
          <button
            className="hero-btn"
            onClick={() =>
          ...
          <div className="hero-stats">
            <div className="stat">
              ...
              <span className="stat-label">Bracelet Varieties</span>
            </div>
            <div className="stat">
              <span className="stat-num">100%</span>
              <span className="stat-label">Natural Gemstones</span>
            </div>
            <div className="stat">
      ...
      <section className="home-collections-showcase">
        <div className="showcase-inner">
          <div className="section-header">
            ...
            <h2>
              Shop by <span>Collections</span>
            </h2>
            <div className="divider"></div>
            <p>
              Explore our masterfully sorted energy groups. Select a collection
              or click directly on any category to view items.
            </p>
          </div>
        ...
        <div className="toolbar-inner">
          ...
          <div className="tb-dropdown-wrap" ref={filterRef}>
            ...
            >
              ...
              <svg
                className={`tb-chevron${filterOpen ? " up" : ""}`}
                viewBox="0 0 24 24"
                width="14"
                height="14"
                fill="none"
          ...
          <div className="tb-dropdown-wrap" ref={catFilterRef}>
            ...
            >
              ...
              <svg
                className={`tb-chevron${catFilterOpen ? " up" : ""}`}
                viewBox="0 0 24 24"
                width="14"
                height="14"
                fill="none"
          ...
          <div className="tb-dropdown-wrap" ref={sortRef}>
            ...
            >
              ...
              {activeSortLabel}
              <svg
                className={`tb-chevron${sortOpen ? " up" : ""}`}
                viewBox="0 0 24 24"
                width="14"
                height="14"
                fill="none"
      ...
      <section className="products-section">
        <div className="section-header fade-in">
          <h2>
            {activeCategory !== "All" ? (
              <>
                ...
                <span>{activeCategory.split(" ").slice(1).join(" ")}</span>
              </>
            ) : activeCollection !== "All" ? (
              <>
                {activeCollection.split(" ")[0]}{" "}
                <span>{activeCollection.split(" ").slice(1).join(" ")}</span>
              </>
            ) : (
              <>
          ...
          <div className="divider"></div>
          <p>
            Explore our premium collection of authentic gemstones and healing
            crystals for wellness, spiritual energy, and beauty.
          </p>
        </div>
